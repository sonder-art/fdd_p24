...
Instrucciones para crear un virtual enviroment:

1. usamos virtual env para crear un virtual enviroment con el siguiente codigo:
	python3 -m venv my_env

2. para activar el vitual enviroment tenmos que usar el siguiente comando:
	source venv/bin/activate
	nota para desactivarlo usas el comando 
		deactivate



Docker: https://hub.docker.com/repository/docker/jaimeum/env/general 
